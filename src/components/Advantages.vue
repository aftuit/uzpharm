...
.advantages_content .curved-line {
  left: 0;
  position: absolute;
  top: 50px;
}
...
.item:nth-child(1) .advantages_top-icon {
  transform: translateY(-85px);
}
.item:nth-child(2) .advantages_top-icon {
  transform: translateY(-85px);
}
.item:nth-child(3) .advantages_top-icon {
  transform: translateY(-40px);
}
.item:nth-child(4) .advantages_top-icon {
  transform: translateY(-85px);
}
.item:nth-child(5) .advantages_top-icon {
  transform: translateY(-40px);
}
.item:nth-child(6) .advantages_top-icon {
