<template>
  <div class="loader">
    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" class="t-icon t-icon-svg t-icon-logo-alpha">
      <path
        stroke="#fff"
